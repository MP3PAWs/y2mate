...
const ContactUs = () => {
  ...
  const languageOptions = [
    {lang: "en", label: "English", path: "/contact/"}
  ];
  ...
  return (
    <>
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section>
          <h1 className="text-center text-2xl font-bold my-3.5">Contact US</h1>
          <form className="mx-auto">
            ...
            <div className="flex items-center justify-center">
              <button className="bg-button hover:bg-primary text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                Submit
              </button>
            </div>
          </form>
...
export const Head = () => (
  <>
    <html lang="en"/>
    <title>Y2mate - Contact Us | Download Youtube Video Free</title>
    <meta
      name="description"
    ...
    <meta property="og:title" content="Y2mate - Contact Us | Download Youtube Video Free"/>
    <meta
      property="og:description"
      content="y2mate is popular Free YouTube Downloader allow to Download YouTube video for Free with high quality in 1080p, 2160p, 2k, 4k, 8k without install software."/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/contact/"/>
    ...
    <link rel="canonical" href="https://y2mate.mobi/contact/"/>
  </>
)
