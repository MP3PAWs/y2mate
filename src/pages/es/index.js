      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Y2mate - Descargador de YouTube en
              línea</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">El mejor descargador de MP3 y MP4 de Youtube</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2Mate es la mejor herramienta de descarga de YouTube rápida y gratuita que lo ayuda a convertir y descargar
            fácilmente sus videos favoritos de YouTube, Facebook, Vimeo, Youku, Twitch, Dailymotion, etc. sin
            publicidad. Usando este convertidor Y2mate puedes descargar mp3 y mp4 de youtube sin limitación. Esto es
            compatible y fácil de usar con todos los dispositivos, como móviles Android, iOS, iPhone, computadora y
            tableta.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            No es necesario instalar aplicaciones y software. Y2mate ofrece una variedad de formatos de audio y video de
            calidad HD como MP3, M4V, MP4, FLV, 3GP, AVI, WEBM, WMV, etc. Es una forma segura y rápida de guardar videos
            de YouTube o cualquier otra plataforma para compartir videos con pasos simples. .
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Instrucciones</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">
                Inserte una palabra clave en el cuadro de entrada o pegue la URL del video que desea convertir
              </li>
              <li className="mb-2.5 text-[17px]">
                Simplemente haga clic en el botón "Iniciar" y la conversión comenzará
              </li>
              <li className="mb-2.5 text-[17px]">
                Seleccione el formato (Video, Audio) y la calidad de la descarga, luego haga clic en el botón
                "Descargar"
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Ventaja Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">
                Disfruta de una cantidad ilimitada de descargas de videos sin costo
              </li>
              <li className="mb-2.5 text-[17px]">
                No es necesario registrarse o iniciar sesión en una cuenta
              </li>
              <li className="mb-2.5 text-[17px]">Soporta descargas con todos los formatos y calidades</li>
              <li className="mb-2.5 text-[17px]">Velocidad de descarga y conversión súper rápida</li>
              <li className="mb-2.5 text-[17px]">Convertidor 100% seguro y protegido</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Descarga gratuita e ilimitada</h3>
            <p className="mb-2.5">Conversión ilimitada de videos de Youtube y descarga gratuita</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Descarga fácil y rápida</h3>
            <p className="mb-2.5">Totalmente compatible con todos los navegadores y dispositivos</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Vídeo y audio de alta calidad</h3>
            <p className="mb-2.5">Admite la descarga de audio y videos de alta calidad como formato original</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5"><b>Sugerencia: </b>elimine www de la URL y agregue <b>“Y2mate”</b> antes de
            "youtube.com" en la URL para descargar videos (MP4) y archivos de audio (MP3) de YouTube como una solución
            más rápida.
          </p>
          <p className="max-w-full mb-0.5">Si no puede descargar videos a su dispositivo, siga estas instrucciones:</p>
          <p className="max-w-full"><b>Paso 1: </b>elija el formato de su elección y haga clic en el botón "Descargar"
          </p>
          <p className="max-w-full mb-2.5"><b>Paso 2: </b> en la nueva ventana, haga clic en "CTRL + S" para guardar el
            video O haga clic derecho en el video, luego seleccione "Guardar como video".</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="es"/>
    <title>Y2mate - Descargador de Youtube | Descargar Video de Youtube Gratis en HD</title>
    <meta
      name="description"
      content="Y2mate es un descargador de YouTube potente y fácil de usar que le permite guardar fácilmente su video favorito de Youtube y descargarlo como música mp3 y archivos mp4 de forma gratuita"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="es"/>
    <meta property="og:title" content="Y2mate - Descargador de Youtube | Descargar Video de Youtube Gratis en HD"/>
    <meta
      property="og:description"
      content="Y2mate es un descargador de YouTube potente y fácil de usar que le permite guardar fácilmente su video favorito de Youtube y descargarlo como música mp3 y archivos mp4 de forma gratuita"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/es/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/es/"/>
    <DownloaderAlternate/>
  </>
)
