      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">YouTube 到 MP3 转换器</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">将 YouTube 转换为 MP3</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate 是最好和最快的 Youtube 到 mp3 转换器工具。我们的 YouTube 到 mp3 工具允许您从 youtube 高质量地转换和下载
            youtube 视频，而无需安装任何软件。Y2mate 在平板电脑、台式机和移动设备上毫不费力地工作。
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            使用此 YouTube 到 Mp3 转换器，可以轻松地从 Youtube 下载不同质量和比特率的 MP3，例如 64kbps、128kbps、192kbps 和高达
            320kbps，因此您可以随时随地收听 mp3 音乐，即使您处于离线状态。
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>如何使用 Y2mate 将 YouTube 视频转换为 MP3</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">打开 YouTube 并复制要转换的 youtube 视频 url</li>
              <li className="mb-2.5 text-[17px]">将 YouTube 网址粘贴到搜索框中</li>
              <li className="mb-2.5 text-[17px]">选择 MP3 质量并单击“下载”按钮</li>
              <li className="mb-2.5 text-[17px]">等待转换过程完成并下载音频文件。</li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">完全免费和无限制使用</li>
              <li className="mb-2.5 text-[17px]">无需注册或安装任何应用程序</li>
              <li className="mb-2.5 text-[17px]">完全安全可靠的转换器</li>
              <li className="mb-2.5 text-[17px]">支持多种高质量音频，如 64kbps、128kbps、192kbps、256kbps 和 320kbps。</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">免费且易于使用</h3>
            <p className="mb-2.5">只需点击几下即可免费将 YouTube 视频转换并保存为 mp3，只需粘贴 YouTube
              网址并点击“开始”按钮。</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">所有设备兼容性</h3>
            <p className="mb-2.5">Y2mate 转换器响应迅速并兼容所有类型的设备，可在移动设备、PC、Android 和 iOS
              上完美运行。也适用于所有浏览器。</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">快速下载无限制</h3>
            <p className="mb-2.5">不受限制地将 YouTube 转换并下载到 Mp3。不适用任何功能限制。</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">在 Youtube.com 网址前插入关键字 <b>“Y2mate”</b> 并点击 Enter 按钮 -
            这将使您可以更快地从 YouTube 下载 mp3。</p>
          <p className="max-w-full mb-0.5">这是一个示例 - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj 选择您要下载的格式，然后单击下载按钮</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="zh-cn"/>
    <title>YouTube 到 MP3 转换器</title>
    <meta
      name="description"
      content="Y2meta 是最好和最快的在线 Youtube 到 Mp3 转换器，可以免费从 youtube 下载 MP3 音乐"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="zh-cn"/>
    <meta property="og:title" content="YouTube 到 MP3 转换器"/>
    <meta
      property="og:description"
      content="Y2meta 是最好和最快的在线 Youtube 到 Mp3 转换器，可以免费从 youtube 下载 MP3 音乐"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/zh-cn/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/zh-cn/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
