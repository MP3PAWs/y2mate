      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Y2mate - 在线 YouTube 下载器</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">最佳 Youtube MP3 和 MP4 下载器</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2Mate 是最好的快速免费 Youtube 下载器工具，可帮助您从 YouTube、Facebook、Vimeo、优酷、Twitch、Dailymotion
            等轻松转换和下载您喜爱的视频，而无需广告。使用此 Y2mate 转换器，您可以不受限制地从 youtube 下载 mp3 和
            mp4。这与所有设备兼容且易于使用，例如 Android 手机、iOS、iPhone、计算机和平板电脑。
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            您无需安装应用程序和软件。Y2mate 提供多种高清质量的音频和视频格式，如 MP3、M4V、MP4、FLV、3GP、AVI、WEBM、WMV
            等。这是一种通过简单的步骤从 YouTube 或任何其他视频共享平台保存视频的安全快速的方法.
          </h4>
        </section>
          ...
          <div className="md:w-[60%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">
                在输入框中插入关键字或粘贴您要转换的视频网址
              </li>
              <li className="mb-2.5 text-[17px]">只需单击“开始”按钮即可开始转换</li>
              <li className="mb-2.5 text-[17px]">
                选择下载格式（视频、音频）和质量，然后单击“下载”按钮
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Y2mate优势</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">享受无限数量的免费视频下载</li>
              <li className="mb-2.5 text-[17px]">无需注册或登录帐户</li>
              <li className="mb-2.5 text-[17px]">支持所有格式和质量的下载</li>
              <li className="mb-2.5 text-[17px]">超快的下载和转换速度</li>
              <li className="mb-2.5 text-[17px]">100% 安全可靠的转换器</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">免费无限下载</h3>
            <p className="mb-2.5">无限的 Youtube 视频转换和免费下载</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">轻松快速下载</h3>
            <p className="mb-2.5">完全兼容所有浏览器和设备</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">高质量视频和音频</h3>
            <p className="mb-2.5">支持以原始格式下载高质量的音频和视频</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5"><b>提示： </b>从 URL 中删除 www 并添加 <b>“Y2mate”</b> 在 URL
            中的“youtube.com”之前从 YouTube 下载视频 (MP4) 和音频 (MP3) 文件作为更快的解决方案。
          </p>
          <p className="max-w-full mb-0.5">如果您无法将视频下载到您的设备，请按照以下步骤操作
            指示：</p>
          <p className="max-w-full"><b>步骤1： </b>选择您选择的格式，然后单击“下载”按钮</p>
          <p className="max-w-full mb-2.5"><b>第2步： </b>在新窗口中，单击“CTRL + S”保存视频或右键单击视频，然后选择“另存为视频”。
          </p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="zh-cn"/>
    <title>Y2mate - Youtube 下载器|免费下载 Youtube 高清视频</title>
    <meta
      name="description"
      content="Y2mate 是易于使用且功能强大的 Youtube 下载器，可让您轻松保存您喜爱的 Youtube 视频并免费将其下载为 mp3 音乐和 mp4 文件"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="zh-cn"/>
    <meta property="og:title" content="Y2mate - Youtube 下载器|免费下载 Youtube 高清视频"/>
    <meta
      property="og:description"
      content="Y2mate 是易于使用且功能强大的 Youtube 下载器，可让您轻松保存您喜爱的 Youtube 视频并免费将其下载为 mp3 音乐和 mp4 文件"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/zh-cn/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/zh-cn/"/>
    <DownloaderAlternate/>
  </>
)
