      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
          ...
          <div className="container mx-auto">
            <div className="flex justify-between items-center">
              <div className="md:flex lg:w-0 lg:flex-1">
                <Link to="/zh-cn/" className="md:inline-flex flex items-center">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">YouTube 到 MP4 转换器 - Y2mate</h1>
            <div className="relative m-auto my-[24px]	md:my-[43px] md:w-[600px]">
              ...
              <button
                ...
                <span className="hidden md:contents">开始</span>
              ...
              <p className="text-xs md:text-sm text-[#666] leading-snug p-1.5">
                使用我们的服务即表示您接受我们的
                <Link className="text-[#c10841]" to="/terms-condition/">&nbsp;使用条款。</Link>
              </p>
            </div>
          </div>
        </section>
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">最好的 YouTube 到 MP4 转换器</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate 是一款流行的在线 youtube 到 mp4 转换器，可让您轻松地将 youtube 视频转换为 MP4
            并以高质量格式下载，而无需安装任何软件。您可以使用最快、最流行的 YouTube 下载器从 YouTube 免费下载视频。使用
            YouTube 到 mp4 转换器既快速又容易。
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            这是下载全高清质量的 YouTube 视频的最佳方式，包括 320p、480p、720p、1080p、4K。因此，您可以离线观看和欣赏视频。这是适用于所有设备（如
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>如何使用 Y2mate 将 Youtube 转换为 mp4</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">转到 YouTube 并打开您要下载的视频</li>
              <li className="mb-2.5 text-[17px]">复制 YouTube 视频的网址</li>
              <li className="mb-2.5 text-[17px]">将 YouTube 视频 url 粘贴到输入框中，然后单击“搜索”按钮</li>
              <li className="mb-2.5 text-[17px]">选择您要从 youtube 下载的视频格式</li>
              <li className="mb-2.5 text-[17px]">等到转换完成后点击“下载”按钮</li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">无需在您的设备上安装软件和程序</li>
              <li className="mb-2.5 text-[17px]">完全安全可靠的基于 Web 的应用程序</li>
              <li className="mb-2.5 text-[17px]">无限制地从 YouTube 下载 Mp4 视频</li>
              <li className="mb-2.5 text-[17px]">用户友好和简单的设计使这个 YouTube 下载易于使用</li>
              <li className="mb-2.5 text-[17px]">您无需登录或注册即可将 YouTube 视频转换为 mp4</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">快速简便的转换</h3>
            <p className="mb-2.5">Y2mate 是一款易于使用的工具，可简化将 YouTube 转换为 mp4 的过程。因此，您可以轻松地从
              YouTube 下载 MP4 视频并离线观看。</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">支持多种格式</h3>
            <p className="mb-2.5">我们的网站提供多种不同类型的视频格式，包括 MP4、MOV、M4A、AVI、WebM、3GP 等。以最佳质量下载视频，例如
              720p、1080p、2k、4k 和高达 8k</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">兼容所有设备</h3>
            <p className="mb-2.5">我们的 YouTube 转 MP4 可在网络浏览器上运行，因此可在所有设备和操作系统上访问，包括
              Android、Windows、Mac、iOS 和 iPhone</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">使用 This YouTube to Mp4 Converter，您可以使用此方法快速下载。只需在 Youtube
            URL 前输入 <b>“Y2mate”</b> 然后点击 Enter 按钮</p>
          <p className="max-w-full mb-0.5">这是示例 - youtube.com/watch?v=abc75hj => y2mateyoutube.com/watch?v=abc75hj
            选择要下载的格式并按下下载按钮</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="zh-cn"/>
    <title>YouTube 到 MP4 转换器 - Y2mate</title>
    <meta
      name="description"
      content="使用 Y2mate 转换器通过简单的步骤将 YouTube 转换为 MP4。它快速、安全、易于使用"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="zh-cn"/>
    <meta property="og:title" content="YouTube 到 MP4 转换器 - Y2mate"/>
    <meta
      property="og:description"
      content="使用 Y2mate 转换器通过简单的步骤将 YouTube 转换为 MP4。它快速、安全、易于使用"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/zh-cn/youtube-to-mp4/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/zh-cn/youtube-to-mp4/"/>
    <MP4Alternate/>
  </>
)
