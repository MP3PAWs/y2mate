      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">YouTube-zu-MP3-Konverter</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Konvertieren Sie YouTube in MP3</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate ist das beste und schnellste Tool zur Konvertierung von YouTube in MP3. Mit unserem
            YouTube-zu-MP3-Tool können Sie YouTube-Videos von YouTube in hoher Qualität konvertieren und herunterladen,
            ohne Software installieren zu müssen. Y2mate funktioniert mühelos auf Tablets, Desktops und Mobilgeräten.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Mit diesem YouTube-zu-MP3-Konverter ist es einfach, MP3 von YouTube in unterschiedlicher Qualität und
            Bitrate herunterzuladen, z. B. 64 KBit/s, 128 KBit/s, 192 KBit/s und bis zu 320 KBit/s, sodass Sie jederzeit
            MP3-Musik hören können, auch wenn Sie offline sind.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>So konvertieren Sie YouTube-Videos mit Y2mate in
              MP3</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Öffnen Sie YouTube und kopieren Sie die YouTube-Video-URL, die Sie
                konvertieren möchten
              </li>
              <li className="mb-2.5 text-[17px]">Geben Sie die YouTube-URL in das Suchfeld ein</li>
              <li className="mb-2.5 text-[17px]">Wählen Sie die MP3-Qualität und klicken Sie auf die Schaltfläche
                „Herunterladen“.
              </li>
              <li className="mb-2.5 text-[17px]">Warten Sie, bis der Konvertierungsvorgang abgeschlossen ist, und laden
                Sie die Audiodatei herunter.
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Völlig kostenlos und unbegrenzte Nutzung</li>
              <li className="mb-2.5 text-[17px]">Es ist keine Registrierung oder Installation von Anwendungen
                erforderlich
              </li>
              <li className="mb-2.5 text-[17px]">Absolut sicherer Konverter</li>
              <li className="mb-2.5 text-[17px]">Unterstützt mehrere hochwertige Audiodaten wie 64 Kbit/s, 128 Kbit/s,
                192 Kbit/s, 256 Kbit/s und 320 Kbit/s.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Kostenlos und einfach zu bedienen</h3>
            <p className="mb-2.5">Konvertieren und speichern Sie YouTube-Videos mit ein paar Klicks kostenlos in MP3.
              Fügen Sie einfach die YouTube-URL ein und klicken Sie auf die Schaltfläche „Start“.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Alle Gerätekompatibilität</h3>
            <p className="mb-2.5">Der Y2mate-Konverter ist reaktionsschnell und kompatibel mit allen Arten von Geräten,
              die perfekt auf Mobilgeräten, PCs, Android und iOS laufen. Funktioniert auch mit allen Browsern.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Schneller Download ohne Einschränkung</h3>
            <p className="mb-2.5">Konvertieren und laden Sie YouTube ohne Einschränkung in MP3 herunter, so oft Sie
              möchten. Es gelten keine Funktionseinschränkungen.</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Geben Sie das Schlüsselwort <b>“Y2mate”</b> vor der YouTube.com-URL ein und
            drücken Sie die Eingabetaste – so können Sie MP3s schneller von YouTube herunterladen.</p>
          <p className="max-w-full mb-0.5">Hier ist ein Beispiel: youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj Wählen Sie das Format aus, das Sie herunterladen möchten, und klicken Sie
            dann auf die Schaltfläche „Herunterladen“.</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    ...
    <meta
      name="description"
      content="Y2meta ist der beste und schnellste Online-YouTube-zu-MP3-Konverter zum kostenlosen Herunterladen von MP3-Musik von YouTube"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="de"/>
    <meta property="og:title" content="YouTube-zu-MP3-Konverter"/>
    <meta
      property="og:description"
      content="Y2meta ist der beste und schnellste Online-YouTube-zu-MP3-Konverter zum kostenlosen Herunterladen von MP3-Musik von YouTube"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/de/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/de/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
