      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Y2mate –
              Online-YouTube-Downloader</h1>
            <div className="relative m-auto my-[24px]	md:my-[43px] md:w-[600px]">
              ...
              <p className="text-xs md:text-sm text-[#666] leading-snug p-1.5">
                ...
                <Link className="text-[#c10841]" to="/terms-condition/">&nbsp;Nutzungsbedingungen.</Link>
              </p>
            </div>
          </div>
        </section>
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Bester YouTube MP3- und MP4-Downloader</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2Mate ist das beste schnelle und kostenlose YouTube-Downloader-Tool, mit dem Sie Ihre Lieblingsvideos von
            YouTube, Facebook, Vimeo, Youku, Twitch, Dailymotion usw. ganz einfach und ohne Werbung konvertieren und
            herunterladen können. Mit diesem Y2mate-Konverter können Sie MP3 und MP4 ohne Einschränkung von YouTube
            herunterladen. Dies ist mit allen Geräten wie Android-Handys, iOS, iPhone, Computer und Tablet kompatibel
            und einfach zu verwenden.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Sie müssen keine Apps und Software installieren. Y2mate bietet eine Vielzahl von Audio- und Videoformaten in
            HD-Qualität wie MP3, M4V, MP4, FLV, 3GP, AVI, WEBM, WMV usw. Es ist eine sichere und schnelle Möglichkeit,
            Videos von YouTube oder einer anderen Video-Sharing-Plattform mit einfachen Schritten zu speichern .
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Anweisungen</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">
                Geben Sie ein Schlüsselwort in das Eingabefeld ein oder fügen Sie die Video-URL ein, die Sie
                konvertieren möchten
              </li>
              <li className="mb-2.5 text-[17px]">
                Klicken Sie einfach auf die Schaltfläche „Start“ und die Konvertierung wird gestartet
              </li>
              <li className="mb-2.5 text-[17px]">
                Wählen Sie das Format (Video, Audio) und die Qualität für den Download aus und klicken Sie dann auf die
                Schaltfläche „Herunterladen“.
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Y2mate-Vorteil</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">
                Genießen Sie eine unbegrenzte Anzahl kostenloser Downloads von Videos
              </li>
              <li className="mb-2.5 text-[17px]">Sie müssen sich nicht registrieren oder ein Konto anmelden</li>
              <li className="mb-2.5 text-[17px]">Unterstützt das Herunterladen aller Formate und Qualitäten</li>
              <li className="mb-2.5 text-[17px]">Superschnelle Download- und Konvertierungsgeschwindigkeit</li>
              <li className="mb-2.5 text-[17px]">100 % sicherer Konverter</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Kostenloser und unbegrenzter Download</h3>
            <p className="mb-2.5">Unbegrenzte Konvertierung von YouTube-Videos und kostenloser Download</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Einfacher und schneller Download</h3>
            <p className="mb-2.5">Vollständig kompatibel mit allen Browsern und Geräten</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Hochwertiges Video und Audio</h3>
            <p className="mb-2.5">Unterstützt den Download hochwertiger Audio- und Videodateien im Originalformat</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5"><b>Tipp: </b>Entfernen Sie „www“ aus der URL und fügen
            Sie <b>„Y2mate“ </b> vor „youtube.com“ in der URL hinzu, um als schnellere Lösung Videos (MP4) und
            Audiodateien (MP3) von YouTube herunterzuladen.
          </p>
          <p className="max-w-full mb-0.5">Wenn Sie kein Video auf Ihr Gerät herunterladen können, befolgen Sie bitte
            diese Anweisungen:</p>
          <p className="max-w-full"><b>Schritt 1: </b> Wählen Sie das gewünschte Format und klicken Sie auf die
            Schaltfläche „Herunterladen“.</p>
          <p className="max-w-full mb-2.5"><b>Schritt 2: </b>Klicken Sie im neuen Fenster auf „STRG + S“, um das Video
            zu speichern, ODER klicken Sie mit der rechten Maustaste auf das Video und wählen Sie dann „Als Video
            speichern“.</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="de"/>
    <title>Y2mate - YouTube-Downloader | Laden Sie YouTube-Videos kostenlos in HD herunter</title>
    <meta
      name="description"
      content="Y2mate ist ein benutzerfreundlicher und leistungsstarker YouTube-Downloader, mit dem Sie Ihre Lieblings-Youtube-Videos ganz einfach speichern und kostenlos als MP3-Musik und MP4-Dateien herunterladen können"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="de"/>
    <meta property="og:title"
          content="Y2mate - YouTube-Downloader | Laden Sie YouTube-Videos kostenlos in HD herunter"/>
    <meta
      property="og:description"
      content="Y2mate ist ein benutzerfreundlicher und leistungsstarker YouTube-Downloader, mit dem Sie Ihre Lieblings-Youtube-Videos ganz einfach speichern und kostenlos als MP3-Musik und MP4-Dateien herunterladen können"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/de/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/de/"/>
    <DownloaderAlternate/>
  </>
)
