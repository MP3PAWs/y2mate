            ...
            <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
                ...
                <section
                    ...
                    <div className="md:py-[30px] py-7 text-center">
                        <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">يوتيوب لتحويل MP4 -
                            Y2mate</h1>
                        <div className="relative m-auto my-[24px]	md:my-[43px] md:w-[600px]">
                            ...
                            <p className="text-xs md:text-sm text-[#666] leading-snug p-1.5">
                                ...
                                <Link className="text-[#c10841]" to="/terms-condition/">&nbsp; شروط الاستخدام الخاصة
                                    بنا</Link>
                            </p>
                        </div>
                    </div>
                ...
                <section className="py-[25px] md:py-[30px] text-center leading-snug">
                    <h2 className="text-[26px] font-bold py-2.5">أفضل محول يوتيوب إلى MP4</h2>
                    <h4 className="my-2.5 text-lg leading-snug">
                        Y2mate هو محول يوتيوب إلى mp4 على الإنترنت شهير يسمح لك بسهولة تحويل مقاطع فيديو youtube إلى MP4
                        وتنزيلها بتنسيقات عالية الجودة دون تثبيت أي برنامج. يمكنك تنزيل مقاطع الفيديو من YouTube مجانًا
                        باستخدام برنامج تنزيل YouTube الأسرع والأكثر شهرة. إنه سريع وسهل استخدام YouTube لتحويل mp4.
                    </h4>
                    <h4 className="my-2.5 text-lg leading-snug">
                        هذه هي أفضل طريقة لتنزيل مقاطع فيديو YouTube بجودة عالية الدقة بما في ذلك 320p ، 480p ، 720p ،
                        1080p ، 4K. حتى تتمكن من مشاهدة مقاطع الفيديو والاستمتاع بها في وضع عدم الاتصال. هذا هو النظام
                        الأساسي الأكثر ملاءمة الذي يعمل على جميع الأجهزة مثل Mac و PC و Android و iOS.
                    </h4>
                </section>
                ...
                <section className="py-[30px] md:flex block justify-between">
                    <div className="md:w-[60%] md:px-[15px]">
                        <h5 className="text-lg my-1.5 font-normal"><strong>كيفية تحويل Youtube إلى mp4 باستخدام
                            Y2mate</strong></h5>
                        <ol className="m-0 pl-4 list-decimal">
                            <li className="mb-2.5 text-[17px]">انتقل إلى YouTube وافتح الفيديو الذي تريد تنزيله</li>
                            <li className="mb-2.5 text-[17px]">انسخ عنوان URL لفيديو YouTube</li>
                            <li className="mb-2.5 text-[17px]">الصق رابط فيديو YouTube في مربع الإدخال وانقر فوق الزر
                                "بحث"
                            </li>
                            <li className="mb-2.5 text-[17px]">اختر تنسيق الفيديو الذي ترغب في تنزيله من youtube</li>
                            <li className="mb-2.5 text-[17px]">انتظر حتى اكتمال التحويل وانقر فوق الزر "تنزيل"</li>
                        </ol>
                    </div>
                    <div className="md:w-[40%] md:px-[15px]">
                        ...
                        <ol className="m-0 pl-4 list-disc">
                            <li className="mb-2.5 text-[17px]">لا حاجة لتثبيت البرامج والبرامج على جهازك</li>
                            <li className="mb-2.5 text-[17px]">تطبيق قائم على الويب آمن تمامًا وآمن</li>
                            <li className="mb-2.5 text-[17px]">قم بتنزيل فيديو بتنسيق Mp4 من يوتيوب بلا حدود</li>
                            <li className="mb-2.5 text-[17px]">تصميم سهل الاستخدام وبسيط يجعل تنزيل YouTube هذا سهل
                                الاستخدام
                            </li>
                            <li className="mb-2.5 text-[17px]">ليس عليك تسجيل الدخول أو التسجيل لتحويل فيديو YouTube إلى
                                mp4
                            </li>
                        </ol>
                    </div>
                ...
                <section className="py-[25px] md:py-[30px] md:flex">
                    <div className="md:w-1/3 text-center">
                        ...
                        <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">تحويل سريع وسهل</h3>
                        <p className="mb-2.5">Y2mate هي أداة سهلة الاستخدام تعمل على تبسيط عملية تحويل YouTube إلى mp4.
                            لذلك يمكنك بسهولة تنزيل مقاطع فيديو MP4 من YouTube ومشاهدتها في وضع عدم الاتصال.</p>
                    </div>
                    <div className="md:w-1/3 text-center">
                        <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
                        <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">دعم صيغ متعددة</h3>
                        <p className="mb-2.5"> يوفر موقعنا الإلكتروني العديد من الأنواع المختلفة لتنسيقات الفيديو ، بما
                            في ذلك MP4 و MOV و M4A و AVI و WebM و 3GP والمزيد. قم بتنزيل الفيديو بأفضل جودة مثل 720p و
                            1080 p و 2 k و 4k وما يصل إلى 8k</p>
                    </div>
                    <div className="md:w-1/3 text-center">
                        <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload"
                                     quality={50}/>
                        <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">متوافق مع جميع الاجهزة</h3>
                        <p className="mb-2.5">يعمل YouTube إلى MP4 الخاص بنا على متصفحات الويب ، لذلك يمكن الوصول إليه
                            على جميع الأجهزة وأنظمة التشغيل بما في ذلك Android و Windows و Mac و iOS و iPhone</p>
                    </div>
                </section>
                <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
                <section className="py-[30px]">
                    <p className="max-w-full mb-2.5">باستخدام محول YouTube إلى Mp4 هذا ، يمكنك التنزيل بسرعة باستخدام
                        هذه الطريقة. ما عليك سوى كتابة <b>“Y2mate”</b> قبل عنوان URL الخاص بـ Youtube واضغط على زر Enter
                    </p>
                    <p className="max-w-full mb-0.5">هذا مثال - youtube.com/watch؟v=abc75hj =>
                        y2mateyoutube.com/watch؟v=abc75hj حدد التنسيق الذي تريد تنزيله واضغط على زر التنزيل</p>
                </section>
            </div>
            <footer>
...
export const Head = () => (
    <>
        <html lang="ar"/>
        <title>يوتيوب لتحويل MP4 - Y2mate</title>
        <meta
            name="description"
            content="قم بتحويل YouTube إلى MP4 باستخدام محول Y2mate بخطوات بسيطة. إنه سريع وآمن وسهل الاستخدام"/>
        <meta name="robots" content="index,follow"/>
        <meta property="og:type" content="website"/>
        <meta property="og:site_name" content="y2mate"/>
        <meta property="og:locale" content="ar"/>
        <meta property="og:title" content="يوتيوب لتحويل MP4 - Y2mate"/>
        <meta
