      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">يوتيوب لتحويل MP3</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">تحويل يوتيوب إلى MP3</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate هو أفضل وأسرع أداة لتحويل Youtube إلى mp3. تتيح لك أداة YouTube to mp3 الخاصة بنا تحويل وتنزيل مقاطع
            فيديو youtube من youtube بجودة عالية دون تثبيت أي برنامج. يعمل Y2mate بسهولة على الأجهزة اللوحية وسطح المكتب
            والأجهزة المحمولة.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            باستخدام محول YouTube إلى MP3 هذا ، من السهل تنزيل MP3 من Youtube بجودة ومعدلات بت مختلفة ، مثل 64 كيلوبت في
            الثانية ، و 128 كيلوبت في الثانية ، و 192 كيلوبت في الثانية ، وما يصل إلى 320 كيلوبت في الثانية ، حتى تتمكن
            من الاستماع إلى موسيقى mp3 وقتما تشاء حتى عندما تكون غير متصل بالإنترنت.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>كيفية تحويل مقاطع فيديو YouTube إلى MP3 باستخدام
              Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">
                افتح YouTube وانسخ عنوان url الخاص بفيديو youtube الذي تريد تحويله
              </li>
              <li className="mb-2.5 text-[17px]">ضع رابط YouTube في مربع البحث</li>
              <li className="mb-2.5 text-[17px]">حدد جودة MP3 وانقر فوق الزر "تنزيل"</li>
              <li className="mb-2.5 text-[17px]">انتظر حتى تكتمل عملية التحويل وقم بتنزيل الملف الصوتي.</li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">استخدام مجاني وغير محدود تمامًا</li>
              <li className="mb-2.5 text-[17px]">لا حاجة للتسجيل أو تثبيت أي تطبيقات</li>
              <li className="mb-2.5 text-[17px]">محول آمن تمامًا وآمن</li>
              <li className="mb-2.5 text-[17px]">دعم العديد من الصوت عالي الجودة مثل 64 كيلوبت في الثانية و 128 كيلوبت
                في الثانية و 192 كيلوبت في الثانية و 256 كيلوبت في الثانية و 320 كيلوبت في الثانية.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">مجاني وسهل الاستخدام</h3>
            <p className="mb-2.5">قم بتحويل وحفظ مقاطع فيديو YouTube إلى mp3 مجانًا ببضع نقرات ، ما عليك سوى لصق عنوان
              url الخاص بـ YouTube والنقر فوق الزر "ابدأ".</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">توافق جميع الأجهزة</h3>
            <p className="mb-2.5">محول Y2mate مستجيب ومتوافق مع جميع أنواع الأجهزة التي تعمل بشكل مثالي على الهاتف
              المحمول والكمبيوتر الشخصي و Android و iOS. يعمل أيضًا مع جميع المتصفحات.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">تنزيل سريع بلا حدود</h3>
            <p className="mb-2.5">قم بتحويل وتنزيل YouTube إلى Mp3 دون قيود بقدر ما تريد. لا توجد قيود على الميزات.</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">أدخل الكلمة الرئيسية <b>“Y2mate”</b> قبل عنوان url لموقع Youtube.com واضغط
            على زر Enter - سيسمح لك ذلك بتنزيل mp3 من YouTube بشكل أسرع.</p>
          <p className="max-w-full mb-0.5">هذا مثال - youtube.com/watch؟v=abc75hj => y2mateyoutube.com/watch؟v=abc75hj
            اختر التنسيق الذي تريد تنزيله ثم انقر فوق زر التنزيل</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="ar"/>
    <title>يوتيوب لتحويل MP3</title>
    <meta
      name="description"
      content="Y2meta هو أفضل وأسرع محول من Youtube to Mp3 على الإنترنت لتنزيل موسيقى MP3 من youtube مجانًا"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="ar"/>
    <meta property="og:title" content="يوتيوب لتحويل MP3"/>
    <meta
      property="og:description"
      content="Y2meta هو أفضل وأسرع محول من Youtube to Mp3 على الإنترنت لتنزيل موسيقى MP3 من youtube مجانًا"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/ar/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/ar/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
