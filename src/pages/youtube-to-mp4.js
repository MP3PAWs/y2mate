      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">YouTube to MP4 Converter -
              Y2mate</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          ...
          <h4 className="my-2.5 text-lg leading-snug">
            This is the best way to download YouTube videos in full HD quality including 320p, 480p, 720p, 1080p, 4K. So
            you can watch and enjoy videos offline. This is the most convenient platform that works on all devices like
            Mac, PC, Android and iOS.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>How to convert Youtube to mp4 with Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Go to YouTube and open the video that you want to download</li>
              <li className="mb-2.5 text-[17px]">Copy the YouTube video's URL</li>
              <li className="mb-2.5 text-[17px]">Paste YouTube Video url into the input box and click “Search” button
              </li>
              <li className="mb-2.5 text-[17px]">Choose the video format you would like to download from youtube</li>
              <li className="mb-2.5 text-[17px]">Wait until the conversion is completed and click “Download” button</li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">No need to install software and programs to your device</li>
              <li className="mb-2.5 text-[17px]">Totally Safe and Secure web based application</li>
              <li className="mb-2.5 text-[17px]">Download Mp4 Video from YouTube without limitation</li>
              <li className="mb-2.5 text-[17px]">User-friendly and simple design make this YouTube Download easy to
                use
              </li>
              <li className="mb-2.5 text-[17px]">You don’t have to login or register for convert YouTube video to mp4
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          ...
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Support Multiple format</h3>
            <p className="mb-2.5">Our website provides many different types of video formats, including MP4, MOV, M4A,
              AVI, WebM, 3GP, and more. Download Video in best quality such as 720p, 1080p, 2k, 4k, and up to 8k</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Compatible with all devices</h3>
            <p className="mb-2.5">Our YouTube to MP4 work on web browsers, so this is accessible on all devices and OS
              including Android, Windows, Mac, iOS and iPhone</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
...
export const Head = () => (
  <>
    <html lang="en"/>
    <title>YouTube to MP4 Converter - Y2mate</title>
    <meta
      name="description"
      content="Convert YouTube to MP4 using Y2mate converter in simple steps. it’s fast, secure, easy to use"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="en"/>
    <meta property="og:title" content="YouTube to MP4 Converter - Y2mate"/>
    <meta
      property="og:description"
      content="Convert YouTube to MP4 using Y2mate converter in simple steps. it’s fast, secure, easy to use"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/youtube-to-mp4/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/youtube-to-mp4/"/>
    <MP4Alternate/>
  </>
)
