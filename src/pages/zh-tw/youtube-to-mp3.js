      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">YouTube 到 MP3 轉換器</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">將 YouTube 轉換為 MP3</h2>
          <h4 className="my-2.5 text-lg leading-snug">Y2mate 是最好和最快的 Youtube 到 mp3 轉換器工具。我們的 YouTube 到
            mp3 工具允許您從 youtube 高質量地轉換和下載 youtube 視頻，而無需安裝任何軟件。Y2mate
            在平板電腦、台式機和移動設備上毫不費力地工作。</h4>
          <h4 className="my-2.5 text-lg leading-snug">使用此 YouTube 到 Mp3 轉換器，可以輕鬆地從 Youtube 下載不同質量和比特率的
            MP3，例如 64kbps、128kbps、192kbps 和高達 320kbps，因此您可以隨時隨地收聽 mp3 音樂，即使您處於離線狀態。</h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>如何使用 Y2mate 將 YouTube 視頻轉換為 MP3</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">打開 YouTube 並複制要轉換的 youtube 視頻 url</li>
              <li className="mb-2.5 text-[17px]">將 YouTube 網址粘貼到搜索框中</li>
              <li className="mb-2.5 text-[17px]">選擇 MP3 質量並單擊“下載”按鈕</li>
              <li className="mb-2.5 text-[17px]">等待轉換過程完成並下載音頻文件。</li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">完全免費和無限制使用</li>
              <li className="mb-2.5 text-[17px]">無需註冊或安裝任何應用程序</li>
              <li className="mb-2.5 text-[17px]">完全安全可靠的轉換器</li>
              <li className="mb-2.5 text-[17px]">支持多種高質量音頻，如 64kbps、128kbps、192kbps、256kbps 和 320kbps。</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">免費且易於使用</h3>
            <p className="mb-2.5">只需點擊幾下即可免費將 YouTube 視頻轉換並保存為 mp3，只需粘貼 YouTube
              網址並點擊“開始”按鈕。</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">所有設備兼容性</h3>
            <p className="mb-2.5">Y2mate 轉換器響應迅速並兼容所有類型的設備，可在移動設備、PC、Android 和 iOS
              上完美運行。也適用於所有瀏覽器。</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">快速下載無限制</h3>
            <p className="mb-2.5">不受限制地將 YouTube 轉換並下載到 Mp3。不適用任何功能限制。</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">在 Youtube.com 網址前插入關鍵字 <b>“Y2mate”</b> 並點擊 Enter 按鈕 -
            這將使您可以更快地從 YouTube 下載 mp3。</p>
          <p className="max-w-full mb-0.5">這是一個示例 - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj 選擇您要下載的格式，然後單擊下載按鈕</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="zh-tw"/>
    <title>YouTube 到 MP3 轉換器</title>
    <meta
      name="description"
      content="Y2meta 是最好和最快的在線 Youtube 到 Mp3 轉換器，可以免費從 youtube 下載 MP3 音樂"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="zh-tw"/>
    <meta property="og:title" content="YouTube 到 MP3 轉換器"/>
    <meta
      property="og:description"
      content="Y2meta 是最好和最快的在線 Youtube 到 Mp3 轉換器，可以免費從 youtube 下載 MP3 音樂"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/zh-tw/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/zh-tw/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
