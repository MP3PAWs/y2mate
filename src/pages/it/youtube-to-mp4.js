      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
          ...
          <div className="container mx-auto">
            <div className="flex justify-between items-center">
              <div className="md:flex lg:w-0 lg:flex-1">
                <Link to="/it/" className="md:inline-flex flex items-center">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Convertitore da YouTube a MP4 -
              Y2mate</h1>
            <div className="relative m-auto my-[24px]	md:my-[43px] md:w-[600px]">
              <input
                ...
                placeholder="Cerca o incolla il link qui..."
              ...
              <button
                ...
                <span className="hidden md:contents">Inizio</span>
              ...
              <p className="text-xs md:text-sm text-[#666] leading-snug p-1.5">
                ...
                <Link className="text-[#c10841]" to="/terms-condition/">&nbsp;Termini di utilizzo.</Link>
              </p>
            </div>
          </div>
        </section>
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Il miglior convertitore da YouTube a MP4</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate è un popolare convertitore online da YouTube a mp4 che ti consente di convertire facilmente i video
            di YouTube in MP4 e scaricarli in formati di alta qualità senza installare alcun software. Puoi scaricare
            video da YouTube gratuitamente con il più veloce e popolare YouTube Downloader. È veloce e facile da usare
            Convertitore da YouTube a mp4.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Questo è il modo migliore per scaricare video di YouTube in qualità Full HD inclusi 320p, 480p, 720p, 1080p,
            4K. Quindi puoi guardare e goderti i video offline. Questa è la piattaforma più conveniente che funziona su
            tutti i dispositivi come Mac, PC, Android e iOS.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Come convertire Youtube in mp4 con Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Vai su YouTube e apri il video che desideri scaricare</li>
              <li className="mb-2.5 text-[17px]">Copia l'URL del video di YouTube</li>
              <li className="mb-2.5 text-[17px]">Incolla l'URL del video di YouTube nella casella di inserimento e fai
                clic sul pulsante "Cerca".
              </li>
              <li className="mb-2.5 text-[17px]">Scegli il formato video che desideri scaricare da youtube</li>
              <li className="mb-2.5 text-[17px]">Attendere fino al completamento della conversione e fare clic sul
                pulsante "Download".
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Funzione Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Non è necessario installare software e programmi sul dispositivo</li>
              <li className="mb-2.5 text-[17px]">Applicazione web totalmente sicura e protetta</li>
              <li className="mb-2.5 text-[17px]">Scarica video Mp4 da YouTube senza limitazioni</li>
              <li className="mb-2.5 text-[17px]">Il design intuitivo e semplice rende questo download di YouTube facile
                da usare
              </li>
              <li className="mb-2.5 text-[17px]">Non è necessario effettuare il login o registrarsi per convertire i
                video di YouTube in mp4
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Conversione facile e veloce</h3>
            <p className="mb-2.5">Y2mate è uno strumento facile da usare che semplifica il processo di conversione di
              YouTube in mp4. Quindi puoi facilmente scaricare video MP4 da YouTube e guardarli offline.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Supporta più formati</h3>
            <p className="mb-2.5">Il nostro sito Web offre molti tipi diversi di formati video, inclusi MP4, MOV, M4A,
              AVI, WebM, 3GP e altri. Scarica video nella migliore qualità come 720p, 1080p, 2k, 4k e fino a 8k</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Compatibile con tutti i dispositivi</h3>
            <p className="mb-2.5">Il nostro YouTube to MP4 funziona sui browser Web, quindi è accessibile su tutti i
              dispositivi e sistemi operativi inclusi Android, Windows, Mac, iOS e iPhone</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Con questo convertitore da YouTube a Mp4 puoi scaricare velocemente usando
            questo metodo. Basta digitare <b>“Y2mate”</b> prima dell'URL di Youtube e premere il pulsante Invio</p>
          <p className="max-w-full mb-0.5">Ecco un esempio: youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj Seleziona il formato che desideri scaricare e premi il pulsante di
            download</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="it"/>
    <title>Convertitore da YouTube a MP4 - Y2mate</title>
    <meta
      name="description"
      content="Converti YouTube in MP4 utilizzando il convertitore Y2mate in semplici passaggi. è veloce, sicuro, facile da usare"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="it"/>
    <meta property="og:title" content="Convertitore da YouTube a MP4 - Y2mate"/>
    <meta
      property="og:description"
      content="Converti YouTube in MP4 utilizzando il convertitore Y2mate in semplici passaggi. è veloce, sicuro, facile da usare"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/it/youtube-to-mp4/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/it/youtube-to-mp4/"/>
    <MP4Alternate/>
  </>
)
