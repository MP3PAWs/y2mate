      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Trình chuyển đổi YouTube sang
              MP3</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Chuyển YouTube sang MP3</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate là công cụ chuyển đổi Youtube sang mp3 tốt nhất và nhanh nhất. Công cụ YouTube sang mp3 của chúng tôi
            cho phép bạn chuyển đổi và tải xuống video youtube từ youtube với chất lượng cao mà không cần cài đặt bất kỳ
            phần mềm nào. Y2mate hoạt động dễ dàng trên máy tính bảng, máy tính để bàn và thiết bị di động.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Với trình chuyển đổi YouTube sang Mp3 này, bạn có thể dễ dàng tải xuống MP3 từ Youtube với chất lượng và tốc
            độ bit khác nhau, chẳng hạn như 64kbps, 128kbps, 192kbps và lên đến 320kbps, vì vậy bạn có thể nghe nhạc mp3
            bất cứ khi nào bạn muốn ngay cả khi bạn ngoại tuyến.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Cách chuyển đổi video YouTube sang MP3 với
              Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Mở YouTube và sao chép url video youtube mà bạn muốn chuyển đổi</li>
              <li className="mb-2.5 text-[17px]">Pate URL YouTube vào hộp tìm kiếm</li>
              <li className="mb-2.5 text-[17px]">Chọn chất lượng MP3 và nhấp vào nút "Tải xuống"</li>
              <li className="mb-2.5 text-[17px]">Đợi cho đến khi quá trình chuyển đổi hoàn tất và tải xuống tệp âm
                thanh.
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Hoàn toàn miễn phí và không giới hạn sử dụng</li>
              <li className="mb-2.5 text-[17px]">Không cần đăng ký hay cài đặt bất kỳ ứng dụng nào</li>
              <li className="mb-2.5 text-[17px]">Bộ chuyển đổi hoàn toàn an toàn và bảo mật</li>
              <li className="mb-2.5 text-[17px]">Hỗ trợ nhiều định dạng âm thanh chất lượng cao như 64kbps, 128kbps,
                192kbps, 256kbps và 320kbps.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Miễn phí và đơn giản để sử dụng</h3>
            <p className="mb-2.5">Chuyển đổi và lưu video YouTube sang mp3 miễn phí với một vài cú nhấp chuột, chỉ cần
              dán url YouTube và nhấp vào nút 'bắt đầu'.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Tất cả khả năng tương thích của thiết
              bị</h3>
            <p className="mb-2.5">Trình chuyển đổi Y2mate phản hồi nhanh và tương thích với tất cả các loại thiết bị
              chạy hoàn hảo trên Di động, PC, Android và iOS. Cũng hoạt động với tất cả các trình duyệt.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Tải xuống nhanh không giới hạn</h3>
            <p className="mb-2.5">Chuyển đổi và tải xuống YouTube sang Mp3 mà không bị giới hạn bao nhiêu tùy thích.
              Không áp dụng hạn chế tính năng.</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Chèn từ khóa <b>“Y2mate”</b> trước url Youtube.com và nhấn nút Enter - thao
            tác này sẽ cho phép bạn tải xuống mp3 từ YouTube nhanh hơn.</p>
          <p className="max-w-full mb-0.5">Đây là một ví dụ - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj Chọn định dạng bạn muốn tải xuống rồi nhấp vào nút tải xuống</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="vi"/>
    <title>Trình chuyển đổi YouTube sang MP3</title>
    <meta
      name="description"
      content="Y2meta là Trình chuyển đổi Youtube sang Mp3 trực tuyến tốt nhất và nhanh nhất để tải nhạc MP3 từ youtube miễn phí"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="vi"/>
    <meta property="og:title" content="Trình chuyển đổi YouTube sang MP3"/>
    <meta
      property="og:description"
      content="Y2meta là Trình chuyển đổi Youtube sang Mp3 trực tuyến tốt nhất và nhanh nhất để tải nhạc MP3 từ youtube miễn phí"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/vi/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/vi/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
