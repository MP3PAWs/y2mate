      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Conversor YouTube para MP3</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Converter YouTube para MP3</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate é a melhor e mais rápida ferramenta de conversão de Youtube para mp3. Nossa ferramenta YouTube para
            mp3 permite que você converta e baixe vídeos do youtube do youtube em alta qualidade sem instalar nenhum
            software. O Y2mate funciona sem esforço em tablets, desktops e dispositivos móveis.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Com este conversor de YouTube para MP3, é fácil baixar MP3 do Youtube de diferentes qualidades e taxas de
            bits, como 64kbps, 128kbps, 192kbps e até 320kbps, para que você possa ouvir música mp3 sempre que quiser,
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Como converter vídeos do YouTube para MP3 com o
              Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Abra o YouTube e copie o URL do vídeo do YouTube que você deseja
                converter
              </li>
              <li className="mb-2.5 text-[17px]">Cole o URL do YouTube na caixa de pesquisa</li>
              <li className="mb-2.5 text-[17px]">Selecione a qualidade MP3 e clique no botão "Download"</li>
              <li className="mb-2.5 text-[17px]">Aguarde até que o processo de conversão seja concluído e baixe o
                arquivo de áudio.
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Uso totalmente gratuito e ilimitado</li>
              <li className="mb-2.5 text-[17px]">Não há necessidade de registro ou instalação de aplicativos</li>
              <li className="mb-2.5 text-[17px]">Conversor totalmente seguro e protegido</li>
              <li className="mb-2.5 text-[17px]">Suporta vários áudios de alta qualidade como 64kbps, 128kbps, 192kbps,
                256kbps e 320kbps.
              </li>
            </ol>
          </div>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Gratuito e simples de usar</h3>
            <p className="mb-2.5">Converta e salve vídeos do YouTube em mp3 gratuitamente com apenas alguns cliques,
              basta colar o URL do YouTube e clicar no botão 'iniciar'.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Compatibilidade com todos os
              dispositivos</h3>
            <p className="mb-2.5">O conversor Y2mate é responsivo e compatível com todos os tipos de dispositivos que
              funcionam perfeitamente em dispositivos móveis, PC, Android e iOS. Também funciona com todos os
              navegadores.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Download rápido sem limitação</h3>
            <p className="mb-2.5">Converta e baixe YouTube para MP3 sem limitação, tanto quanto você quiser. Nenhuma
              restrição de recurso se aplica.</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Insira a palavra-chave <b>“Y2mate”</b> antes do URL do Youtube.com e
            pressione o botão Enter - isso permitirá que você baixe mp3 do YouTube mais rapidamente.</p>
          <p className="max-w-full mb-0.5">Aqui está um exemplo - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj Escolha o formato que deseja baixar e clique no botão de download</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    ...
    <meta
      name="description"
      content="Y2meta é o melhor e mais rápido conversor online do Youtube para Mp3 para baixar músicas em MP3 do youtube gratuitamente"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="pt"/>
    <meta property="og:title" content="Conversor YouTube para MP3"/>
    <meta
      property="og:description"
      content="Y2meta é o melhor e mais rápido conversor online do Youtube para Mp3 para baixar músicas em MP3 do youtube gratuitamente"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/pt/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/pt/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
