      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
          ...
          <div className="container mx-auto">
            <div className="flex justify-between items-center">
              <div className="md:flex lg:w-0 lg:flex-1">
                <Link to="/pt/" className="md:inline-flex flex items-center">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Conversor de YouTube para MP4 -
              Y2mate</h1>
            <div className="relative m-auto my-[24px]	md:my-[43px] md:w-[600px]">
              ...
              <button
                ...
                <span className="hidden md:contents">Começar</span>
              ...
              <p className="text-xs md:text-sm text-[#666] leading-snug p-1.5">
                Ao usar nosso serviço, você está aceitando nossos
                <Link className="text-[#c10841]" to="/terms-condition/">&nbsp;Termos de Uso.</Link>
              </p>
            </div>
          </div>
        </section>
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Melhor conversor de YouTube para MP4</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            O Y2mate é um popular conversor online de youtube para mp4 que permite converter facilmente vídeos do
            youtube para MP4 e baixar em formatos de alta qualidade sem instalar nenhum software. Você pode baixar
            vídeos do YouTube gratuitamente com o YouTube Downloader mais rápido e popular. É rápido e fácil usar o
            conversor do YouTube para mp4.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Esta é a melhor maneira de baixar vídeos do YouTube em qualidade Full HD, incluindo 320p, 480p, 720p, 1080p,
            4K. Assim, você pode assistir e curtir vídeos offline. Esta é a plataforma mais conveniente que funciona em
            todos os dispositivos como Mac, PC, Android e iOS.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Como converter Youtube para mp4 com Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Vá para o YouTube e abra o vídeo que você deseja baixar</li>
              <li className="mb-2.5 text-[17px]">Copie o URL do vídeo do YouTube</li>
              <li className="mb-2.5 text-[17px]">Cole o URL do vídeo do YouTube na caixa de entrada e clique no botão
                "Pesquisar"
              </li>
              <li className="mb-2.5 text-[17px]">Escolha o formato de vídeo que você gostaria de baixar do youtube</li>
              <li className="mb-2.5 text-[17px]">Aguarde até que a conversão seja concluída e clique no botão
                “Download”
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Recurso Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Não há necessidade de instalar software e programas em seu
                dispositivo
              </li>
              <li className="mb-2.5 text-[17px]">Aplicativo baseado na Web totalmente seguro e protegido</li>
              <li className="mb-2.5 text-[17px]">Baixe o vídeo MP4 do YouTube sem limitação</li>
              <li className="mb-2.5 text-[17px]">O design simples e fácil de usar torna este download do YouTube fácil
                de usar
              </li>
              <li className="mb-2.5 text-[17px]">Você não precisa fazer login ou se registrar para converter vídeo do
                YouTube para mp4
              </li>
            </ol>
          </div>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Conversão rápida e fácil</h3>
            <p className="mb-2.5">Y2mate é uma ferramenta fácil de usar que simplifica o processo de conversão do
              YouTube para mp4. Assim, você pode facilmente baixar vídeos MP4 do YouTube e assisti-los offline.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Suporta vários formatos</h3>
            <p className="mb-2.5">Nosso site oferece muitos tipos diferentes de formatos de vídeo, incluindo MP4, MOV,
              M4A, AVI, WebM, 3GP e muito mais. Baixe o vídeo na melhor qualidade, como 720p, 1080p, 2k, 4k e até 8k</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Compatível com todos os dispositivos</h3>
            <p className="mb-2.5">Nosso YouTube para MP4 funciona em navegadores da Web, portanto, pode ser acessado em
              todos os dispositivos e sistemas operacionais, incluindo Android, Windows, Mac, iOS e iPhone</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Com este conversor de YouTube para MP4, você pode baixar rapidamente usando
            este método. Basta digitar <b>“Y2mate”</b> antes do URL do Youtube e apertar o botão Enter</p>
          <p className="max-w-full mb-0.5">Aqui está um exemplo - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj Selecione o formato que deseja baixar e pressione o botão de download</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="pt"/>
    <title>Conversor de YouTube para MP4 - Y2mate</title>
    <meta
      name="description"
      content="Converta YouTube para MP4 usando o conversor Y2mate em etapas simples. é rápido, seguro, fácil de usar"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="pt"/>
    <meta property="og:title" content="Conversor de YouTube para MP4 - Y2mate"/>
    <meta
      property="og:description"
      content="Converta YouTube para MP4 usando o conversor Y2mate em etapas simples. é rápido, seguro, fácil de usar"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/pt/youtube-to-mp4/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/pt/youtube-to-mp4/"/>
    <MP4Alternate/>
  </>
)
