      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">YouTube ke MP3 Converter</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Tukar YouTube kepada MP3</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate ialah alat penukar Youtube ke mp3 yang terbaik dan terpantas. Alat YouTube kepada mp3 kami
            membolehkan anda menukar dan memuat turun video youtube daripada youtube dalam kualiti tinggi tanpa memasang
            sebarang perisian. Y2mate berfungsi dengan mudah pada tablet, desktop dan peranti mudah alih.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Dengan penukar YouTube ke Mp3 ini, mudah untuk memuat turun MP3 daripada Youtube dengan kualiti dan kadar
            bit yang berbeza, seperti 64kbps, 128kbps, 192kbps dan sehingga 320kbps, jadi anda boleh mendengar muzik mp3
            pada bila-bila masa anda mahu walaupun anda berada di luar talian.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Bagaimana untuk menukar video YouTube kepada MP3 dengan
              Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Buka YouTube dan salin url video youtube yang anda ingin tukar</li>
              <li className="mb-2.5 text-[17px]">Pate Url YouTube ke dalam kotak carian</li>
              <li className="mb-2.5 text-[17px]">Pilih kualiti MP3 dan klik butang "Muat turun".</li>
              <li className="mb-2.5 text-[17px]">Tunggu sehingga proses penukaran selesai dan muat turun fail audio.
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Penggunaan Percuma dan Tanpa Had sepenuhnya</li>
              <li className="mb-2.5 text-[17px]">Tidak perlu mendaftar atau memasang sebarang aplikasi</li>
              <li className="mb-2.5 text-[17px]">Penukar yang benar-benar selamat dan selamat</li>
              <li className="mb-2.5 text-[17px]">Menyokong berbilang audio berkualiti tinggi seperti 64kbps, 128kbps,
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Percuma dan mudah digunakan</h3>
            <p className="mb-2.5">Tukar dan simpan video YouTube kepada mp3 percuma dengan beberapa klik, cuma tampal
              url YouTube dan klik pada butang 'mula'.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Keserasian Semua Peranti</h3>
            <p className="mb-2.5">Penukar Y2mate adalah responsif dan serasi untuk semua jenis peranti yang berjalan
              dengan sempurna pada Mudah Alih, PC, Android dan iOS. Juga berfungsi dengan semua penyemak imbas.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Muat Turun Pantas tanpa had</h3>
            <p className="mb-2.5">Tukar dan muat turun YouTube ke Mp3 tanpa had seberapa banyak yang anda mahu. Tiada
              sekatan ciri dikenakan.</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Masukkan Kata Kunci <b>“Y2mate”</b> sebelum url Youtube.com dan tekan butang
            Enter - ini akan membolehkan anda memuat turun mp3 daripada YouTube dengan lebih pantas.</p>
          <p className="max-w-full mb-0.5">Berikut ialah contoh - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj Pilih format yang anda ingin muat turun dan kemudian klik butang muat
            turun</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="ms"/>
    <title>YouTube ke MP3 Converter</title>
    <meta
      name="description"
      content="Y2meta ialah Youtube ke Mp3 Converter dalam talian terbaik dan terpantas untuk memuat turun muzik MP3 dari youtube secara percuma"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="ms"/>
    <meta property="og:title" content="YouTube ke MP3 Converter"/>
    <meta
      property="og:description"
      content="Y2meta ialah Youtube ke Mp3 Converter dalam talian terbaik dan terpantas untuk memuat turun muzik MP3 dari youtube secara percuma"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/ms/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/ms/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
