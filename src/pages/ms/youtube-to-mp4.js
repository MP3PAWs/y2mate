      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
          ...
          <div className="container mx-auto">
            <div className="flex justify-between items-center">
              <div className="md:flex lg:w-0 lg:flex-1">
                <Link to="/ms/" className="md:inline-flex flex items-center">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Penukar YouTube ke MP4 - Y2mate</h1>
            <div className="relative m-auto my-[24px]	md:my-[43px] md:w-[600px]">
              <input
                ...
                placeholder="Cari atau tampal pautan di sini..."
              ...
              <button
                ...
                <span className="hidden md:contents">Mulakan</span>
              ...
              <p className="text-xs md:text-sm text-[#666] leading-snug p-1.5">
                ...
                <Link className="text-[#c10841]" to="/terms-condition/">&nbsp;Syarat Penggunaan kami.</Link>
              </p>
            </div>
          </div>
        </section>
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Penukar YouTube ke MP4 Terbaik</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate ialah penukar youtube ke mp4 dalam talian yang popular yang membolehkan anda menukar video youtube
            kepada MP4 dengan mudah dan memuat turun dalam format berkualiti tinggi tanpa memasang sebarang perisian.
            Anda boleh memuat turun video daripada YouTube secara percuma dengan YouTube Downloader yang paling pantas
            dan popular. Ia pantas dan mudah untuk menggunakan penukar YouTube ke mp4.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Ini ialah cara terbaik untuk memuat turun video YouTube dalam kualiti HD penuh termasuk 320p, 480p, 720p,
            1080p, 4K. Jadi anda boleh menonton dan menikmati video di luar talian. Ini adalah platform paling mudah
            yang berfungsi pada semua peranti seperti Mac, PC, Android dan iOS.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Bagaimana untuk menukar Youtube kepada mp4 dengan
              Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Pergi ke YouTube dan buka video yang ingin anda muat turun</li>
              <li className="mb-2.5 text-[17px]">Salin URL video YouTube</li>
              <li className="mb-2.5 text-[17px]">Tampalkan url Video YouTube ke dalam kotak input dan klik butang
                "Cari".
              </li>
              <li className="mb-2.5 text-[17px]">Pilih format video yang anda ingin muat turun dari youtube</li>
              <li className="mb-2.5 text-[17px]">Tunggu sehingga penukaran selesai dan klik butang "Muat turun".</li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Ciri Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Tidak perlu memasang perisian dan program pada peranti anda</li>
              <li className="mb-2.5 text-[17px]">Aplikasi berasaskan web yang Benar-benar Selamat dan Selamat</li>
              <li className="mb-2.5 text-[17px]">Muat turun Video Mp4 dari YouTube tanpa had</li>
              <li className="mb-2.5 text-[17px]">Reka bentuk yang mesra pengguna dan ringkas menjadikan Muat Turun
                YouTube ini mudah digunakan
              </li>
              <li className="mb-2.5 text-[17px]">Anda tidak perlu log masuk atau mendaftar untuk menukar video YouTube
                kepada mp4
              </li>
            </ol>
          </div>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Penukaran Pantas dan Mudah</h3>
            <p className="mb-2.5">Y2mate ialah alat yang mudah digunakan yang memudahkan proses untuk menukar YouTube
              kepada mp4. Jadi anda boleh memuat turun video MP4 dari YouTube dengan mudah dan menontonnya di luar
              talian.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Menyokong pelbagai format</h3>
            <p className="mb-2.5">Tapak web kami menyediakan pelbagai jenis format video, termasuk MP4, MOV, M4A, AVI,
              WebM, 3GP dan banyak lagi. Muat turun Video dalam kualiti terbaik seperti 720p, 1080p, 2k, 4k dan sehingga
              8k</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Serasi dengan semua peranti</h3>
            <p className="mb-2.5">YouTube ke MP4 kami berfungsi pada penyemak imbas web, jadi ini boleh diakses pada
              semua peranti dan OS termasuk Android, Windows, Mac, iOS dan iPhone</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Dengan Penukar YouTube ke Mp4 ini anda boleh memuat turun dengan pantas
            menggunakan kaedah ini. Cuma taip <b>“Y2mate”</b> sebelum URL Youtube dan tekan butang Enter</p>
          <p className="max-w-full mb-0.5">Berikut ialah contoh - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj Pilih format yang anda mahu muat turun dan tekan butang muat turun</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="ms"/>
    <title>Penukar YouTube ke MP4 - Y2mate</title>
    <meta
      name="description"
      content="Tukar YouTube kepada MP4 menggunakan penukar Y2mate dengan langkah mudah. ia pantas, selamat, mudah digunakan"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="ms"/>
    <meta property="og:title" content="Penukar YouTube ke MP4 - Y2mate"/>
    <meta
      property="og:description"
      content="Tukar YouTube kepada MP4 menggunakan penukar Y2mate dengan langkah mudah. ia pantas, selamat, mudah digunakan"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/ms/youtube-to-mp4/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/ms/youtube-to-mp4/"/>
    <MP4Alternate/>
  </>
)
