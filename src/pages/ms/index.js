      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Y2mate - Muat Turun YouTube Dalam
              Talian</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Youtube MP3 & MP4 Downloader Terbaik</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2Mate ialah alat Youtube Downloader pantas dan percuma terbaik yang membantu anda menukar & memuat turun
            video kegemaran anda dengan mudah daripada YouTube, Facebook, Vimeo, Youku, Twitch, Dailymotion, dll tanpa
            pengiklanan. menggunakan penukar Y2mate ini anda boleh memuat turun mp3 dan mp4 dari youtube tanpa had. Ini
            serasi dan mudah digunakan dengan semua peranti seperti Mudah Alih Android, iOS, iPhone, Komputer dan
            tablet.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Anda tidak perlu memasang apl dan perisian. Y2mate menyediakan pelbagai format audio dan video berkualiti HD
            seperti MP3, M4V, MP4, FLV, 3GP, AVI, WEBM, WMV dll. Ia adalah cara yang selamat dan pantas untuk menyimpan
            video daripada YouTube atau mana-mana platform perkongsian video lain dengan langkah mudah .
            tablet.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Arahan</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">
                Masukkan kata kunci dalam kotak input atau tampal url video yang ingin anda tukar
              </li>
              <li className="mb-2.5 text-[17px]">Hanya klik pada butang "Mula" dan penukaran akan dimulakan</li>
              <li className="mb-2.5 text-[17px]">
                Pilih format (Video, Audio) dan kualiti untuk muat turun, kemudian klik butang "Muat turun".
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Kelebihan Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">
                Nikmati jumlah muat turun video tanpa had secara percuma
              </li>
              <li className="mb-2.5 text-[17px]">Tidak perlu mendaftar atau log masuk akaun</li>
              <li className="mb-2.5 text-[17px]">Menyokong muat turun dengan semua format dan kualiti</li>
              <li className="mb-2.5 text-[17px]">Kelajuan muat turun dan penukaran yang sangat pantas</li>
              <li className="mb-2.5 text-[17px]">100% Penukar selamat dan selamat</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Muat turun percuma dan tanpa had</h3>
            <p className="mb-2.5">Penukaran Video Youtube tanpa had dan muat turun percuma</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Muat Turun Mudah dan Pantas</h3>
            <p className="mb-2.5">Serasi Sepenuhnya dengan semua penyemak imbas dan peranti</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Video & Audio Berkualiti Tinggi</h3>
            <p className="mb-2.5">Menyokong muat turun audio dan video berkualiti tinggi sebagai format asal</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5"><b>Petua: </b>Alih keluar www daripada URL dan
            tambahkan <b>“Y2mate”</b> sebelum "youtube.com" dalam URL untuk memuat turun fail video( MP4 ) dan audio(
            MP3 ) daripada YouTube sebagai penyelesaian yang lebih pantas.
          </p>
          <p className="max-w-full mb-0.5">Jika anda tidak dapat memuat turun video ke Peranti anda, sila ikut arahan
            ini:</p>
          <p className="max-w-full"><b>Langkah 1: </b>pilih format pilihan anda dan klik butang "Muat turun".</p>
          <p className="max-w-full mb-2.5"><b>Langkah2: </b>Dalam tetingkap baharu, klik "CTRL + S" untuk menyimpan
            video ATAU klik kanan ke video, kemudian pilih "Simpan sebagai Video".</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="ms"/>
    <title>Y2mate - Youtube Downloader | Muat turun Video Youtube Percuma dalam HD</title>
    <meta
      name="description"
      content="Y2mate ialah pemuat turun Youtube yang mudah digunakan dan berkuasa yang membolehkan anda menyimpan video Youtube kegemaran anda dengan mudah dan memuat turunnya sebagai muzik mp3 dan fail mp4 secara percuma"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="ms"/>
    <meta property="og:title" content="Y2mate - Youtube Downloader | Muat turun Video Youtube Percuma dalam HD"/>
    <meta
      property="og:description"
      content="Y2mate ialah pemuat turun Youtube yang mudah digunakan dan berkuasa yang membolehkan anda menyimpan video Youtube kegemaran anda dengan mudah dan memuat turunnya sebagai muzik mp3 dan fail mp4 secara percuma"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/ms/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/ms/"/>
    <DownloaderAlternate/>
  </>
)
