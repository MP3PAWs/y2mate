...
const Download = (props) => {
  ...
  const languageOptions = [
    { lang: "en", label: "English", path: "/download/" }
  ];
          ...
          <div className="md:py-[30px] py-7 text-center">
            ...
            <div className="max-w-[800px] m-auto m-6">
              <iframe
                ...
                src={`https://ytapi.download/api/widgetv2?url=https://www.youtube.com/watch?v=${url}`} />
            </div>
          </div>
        </section>
      </div>
...
export const Head = () => (
  <>
    ...
    <meta property="og:url" content="https://y2mate.mobi/download/" />
    ...
    <link rel="canonical" href="https://y2mate.mobi/download/" />
  </>
)
