      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">YouTube'dan MP3'e Dönüştürücü</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">YouTube'u MP3'e dönüştürün</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate en iyi ve en hızlı Youtube'dan mp3'e dönüştürme aracıdır. YouTube'dan mp3'e aracımız, herhangi bir
            yazılım yüklemeden youtube'daki youtube videolarını yüksek kalitede dönüştürmenize ve indirmenize olanak
            tanır. Y2mate tablet, masaüstü ve mobil cihazlarda zahmetsizce çalışır.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Bu YouTube'dan Mp3'e dönüştürücü ile, Youtube'dan 64kbps, 128kbps, 192kbps ve 320kbps'ye kadar farklı kalite
            ve bit hızlarında MP3 indirmek kolaydır, böylece çevrimdışıyken bile istediğiniz zaman mp3 müzik
            dinleyebilirsiniz.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Y2mate ile YouTube videolarını MP3'e dönüştürme</strong>
            </h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">YouTube'u açın ve dönüştürmek istediğiniz youtube video URL'sini
                kopyalayın
              </li>
              <li className="mb-2.5 text-[17px]">YouTube URL'sini arama kutusuna yapıştırın</li>
              <li className="mb-2.5 text-[17px]">MP3 kalitesini seçin ve "İndir" düğmesine tıklayın</li>
              <li className="mb-2.5 text-[17px]">Dönüştürme işlemi tamamlanana kadar bekleyin ve ses dosyasını
                indirin.
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Tamamen Ücretsiz ve Sınırsız kullanım</li>
              <li className="mb-2.5 text-[17px]">Kaydolmaya veya herhangi bir uygulama yüklemeye gerek yok</li>
              <li className="mb-2.5 text-[17px]">Tamamen güvenli dönüştürücü</li>
              <li className="mb-2.5 text-[17px]">64kbps, 128kbps, 192kbps, 256kbps ve 320kbps gibi birden çok yüksek
                kaliteli sesi destekledi.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Ücretsiz ve kullanımı basit</h3>
            <p className="mb-2.5">YouTube videolarını birkaç tıklamayla ücretsiz olarak mp3'e dönüştürün ve kaydedin,
              yalnızca YouTube URL'sini yapıştırın ve 'başlat' düğmesine tıklayın.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Tüm Cihaz uyumluluğu</h3>
            <p className="mb-2.5">Y2mate dönüştürücü, Mobil, PC, Android ve iOS'ta mükemmel şekilde çalışan her tür
              cihaz için duyarlı ve uyumludur. Ayrıca tüm tarayıcılarla çalışır.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Sınırlama olmaksızın Hızlı İndirme</h3>
            <p className="mb-2.5">YouTube'u sınırsız olarak istediğiniz kadar Mp3'e dönüştürün ve indirin. Hiçbir
              özellik kısıtlaması uygulanmaz.</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">Youtube.com URL'sinden önce <b>“Y2mate”</b> Anahtar Kelimesini girin ve Enter
            düğmesine basın - bu, YouTube'dan daha hızlı mp3 indirmenizi sağlayacaktır.</p>
          <p className="max-w-full mb-0.5">İşte bir örnek - youtube.com/watch?v=abc75hj =>
            y2mateyoutube.com/watch?v=abc75hj İndirmek istediğiniz formatı seçin ve ardından indir düğmesine
            tıklayın</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="tr"/>
    <title>YouTube'dan MP3'e Dönüştürücü</title>
    <meta
      name="description"
      content="Y2meta, youtube'dan ücretsiz olarak MP3 müzik indirmek için en iyi ve en hızlı çevrimiçi Youtube to Mp3 Converter'dır."/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="tr"/>
    <meta property="og:title" content="YouTube'dan MP3'e Dönüştürücü"/>
    <meta
      property="og:description"
      content="Y2meta, youtube'dan ücretsiz olarak MP3 müzik indirmek için en iyi ve en hızlı çevrimiçi Youtube to Mp3 Converter'dır."/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/tr/youtube-to-mp3/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/tr/youtube-to-mp3/"/>
    <MP3Alternate/>
  </>
)
