      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Y2mate - онлайн-загрузчик
              YouTube</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Лучший загрузчик Youtube MP3 и MP4</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2Mate — это лучший быстрый и бесплатный инструмент для загрузки Youtube, который поможет вам легко
            конвертировать и загружать ваши любимые видео с YouTube, Facebook, Vimeo, Youku, Twitch, Dailymotion и т. д.
            без рекламы. с помощью этого конвертера Y2mate вы можете скачивать mp3 и mp4 с YouTube без ограничений. Это
            совместимо и просто в использовании со всеми устройствами, такими как мобильные телефоны Android, iOS,
            iPhone, компьютер и планшет.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Вам не нужно устанавливать приложения и программное обеспечение. Y2mate предоставляет различные аудио- и
            видеоформаты HD-качества, такие как MP3, M4V, MP4, FLV, 3GP, AVI, WEBM, WMV и т. д. Это безопасный и быстрый
            способ сохранять видео с YouTube или любой другой платформы для обмена видео с помощью простых шагов. .
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>инструкции</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">
                Вставьте ключевое слово в поле ввода или вставьте URL-адрес видео, которое вы хотите преобразовать.
              </li>
              <li className="mb-2.5 text-[17px]">Просто нажмите кнопку «Пуск», и преобразование начнется.</li>
              <li className="mb-2.5 text-[17px]">
                Выберите формат (Видео, Аудио) и качество для загрузки, затем нажмите кнопку «Скачать».
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Преимущество Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">
                Наслаждайтесь неограниченным количеством бесплатных загрузок видео
              </li>
              <li className="mb-2.5 text-[17px]">Нет необходимости регистрироваться или входить в учетную запись</li>
              <li className="mb-2.5 text-[17px]">Поддержка загрузки во всех форматах и ​​качествах</li>
              <li className="mb-2.5 text-[17px]">Супер быстрая скорость загрузки и конвертации</li>
              <li className="mb-2.5 text-[17px]">100% безопасный и надежный конвертер</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Бесплатная и неограниченная загрузка</h3>
            <p className="mb-2.5">Неограниченное преобразование видео с Youtube и бесплатная загрузка</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Простая и быстрая загрузка</h3>
            <p className="mb-2.5">Полностью совместим со всеми браузерами и устройствами</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Высококачественное видео и аудио</h3>
            <p className="mb-2.5">Поддержка загрузки аудио и видео высокого качества в оригинальном формате</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5"><b>Совет. </b>Удалите www из URL-адреса и добавьте <b>“Y2mate”</b> перед
            «youtube.com» в URL-адресе, чтобы загружать видео (MP4) и аудио (MP3) файлы с YouTube в качестве более
            быстрого решения.
          </p>
          <p className="max-w-full mb-0.5">Если вы не можете загрузить видео на свое Устройство, следуйте этим
            инструкциям:</p>
          <p className="max-w-full"><b>Шаг 1: </b>выберите нужный формат и нажмите кнопку «Скачать».</p>
          <p className="max-w-full mb-2.5"><b>Шаг 2: </b>В новом окне нажмите «CTRL + S», чтобы сохранить видео, ИЛИ
            щелкните правой кнопкой мыши видео, затем выберите «Сохранить как видео».</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="ru"/>
    <title>Y2mate - загрузчик Youtube | Скачать видео с Youtube бесплатно в HD</title>
    <meta
      name="description"
      content="Y2mate - это простой в использовании и мощный загрузчик Youtube, который позволяет вам легко сохранять ваши любимые видео с Youtube и бесплатно загружать их в виде музыкальных файлов mp3 и mp4."/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="ru"/>
    <meta property="og:title" content="Y2mate - загрузчик Youtube | Скачать видео с Youtube бесплатно в HD"/>
    <meta
      property="og:description"
      content="Y2mate - это простой в использовании и мощный загрузчик Youtube, который позволяет вам легко сохранять ваши любимые видео с Youtube и бесплатно загружать их в виде музыкальных файлов mp3 и mp4."/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/ru/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/ru/"/>
    <DownloaderAlternate/>
  </>
)
