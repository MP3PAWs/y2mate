      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Конвертер YouTube в MP4 -
              Y2mate</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Лучший конвертер YouTube в MP4</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Y2mate — это популярный онлайн-конвертер YouTube в MP4, который позволяет легко конвертировать видео с
            YouTube в MP4 и загружать в форматах высокого качества без установки какого-либо программного обеспечения.
            Вы можете бесплатно скачивать видео с YouTube с помощью самого быстрого и популярного загрузчика YouTube.
            Это быстрый и простой в использовании конвертер YouTube в mp4.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Это лучший способ скачать видео с YouTube в формате Full HD, включая 320p, 480p, 720p, 1080p, 4K. Таким
            образом, вы можете смотреть и наслаждаться видео в автономном режиме. Это самая удобная платформа, которая
            работает на всех устройствах, таких как Mac, ПК, Android и iOS.
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Как конвертировать Youtube в mp4 с помощью
              Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Перейдите на YouTube и откройте видео, которое хотите скачать.</li>
              <li className="mb-2.5 text-[17px]">Скопируйте URL-адрес видео YouTube</li>
              <li className="mb-2.5 text-[17px]">Вставьте URL-адрес видео YouTube в поле ввода и нажмите кнопку
                «Поиск».
              </li>
              <li className="mb-2.5 text-[17px]">Выберите формат видео, которое вы хотите скачать с YouTube.</li>
              <li className="mb-2.5 text-[17px]">Дождитесь завершения конвертации и нажмите кнопку «Скачать».</li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            ...
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Нет необходимости устанавливать программное обеспечение и программы на
                ваше устройство
              </li>
              <li className="mb-2.5 text-[17px]">Полностью безопасное и надежное веб-приложение</li>
              <li className="mb-2.5 text-[17px]">Скачать видео Mp4 с YouTube без ограничений</li>
              <li className="mb-2.5 text-[17px]">Удобный и простой дизайн делает эту загрузку с YouTube простой в
                использовании.
              </li>
              <li className="mb-2.5 text-[17px]">Вам не нужно входить в систему или регистрироваться, чтобы
                конвертировать видео с YouTube в mp4.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Быстрое и простое преобразование</h3>
            <p className="mb-2.5">Y2mate — это простой в использовании инструмент, который упрощает процесс
              преобразования YouTube в mp4. Таким образом, вы можете легко загружать видео в формате MP4 с YouTube и
              смотреть их в автономном режиме.</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Поддержка нескольких форматов</h3>
            <p className="mb-2.5">Наш веб-сайт предоставляет множество различных типов видеоформатов, включая MP4, MOV,
              M4A, AVI, WebM, 3GP и другие. Скачивайте видео в лучшем качестве, таком как 720p, 1080p, 2k, 4k и до
              8k</p>
          </div>
          <div className="md:w-1/3 text-center">
            ...
            <p className="mb-2.5">Наш YouTube в MP4 работает в веб-браузерах, поэтому он доступен на всех устройствах и
              ОС, включая Android, Windows, Mac, iOS и iPhone.</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5">С помощью этого конвертера YouTube в Mp4 вы можете быстро скачать этот метод.
            Просто введите <b>“Y2mate”</b> перед URL-адресом Youtube и нажмите кнопку «Ввод».</p>
...
export const Head = () => (
  <>
    <html lang="ru"/>
    <title>Конвертер YouTube в MP4 - Y2mate</title>
    <meta
      name="description"
      content="Конвертируйте YouTube в MP4 с помощью конвертера Y2mate за несколько простых шагов. это быстро, безопасно, просто в использовании"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="ru"/>
    <meta property="og:title" content="Конвертер YouTube в MP4 - Y2mate"/>
    <meta
      property="og:description"
      content="Конвертируйте YouTube в MP4 с помощью конвертера Y2mate за несколько простых шагов. это быстро, безопасно, просто в использовании"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/ru/youtube-to-mp4/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/ru/youtube-to-mp4/"/>
    <MP4Alternate/>
  </>
)
