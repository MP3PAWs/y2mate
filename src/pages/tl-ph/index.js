      ...
      <div className="mx-auto md:max-w-[890px] px-3 md:px-0">
        ...
        <section
          ...
          <div className="md:py-[30px] py-7 text-center">
            <h1 className="mb-2.5 md:text-[34px] leading-snug text-2xl font-medium">Y2mate - Online na YouTube
              Downloader</h1>
        ...
        <section className="py-[25px] md:py-[30px] text-center leading-snug">
          <h2 className="text-[26px] font-bold py-2.5">Pinakamahusay na Youtube MP3 at MP4 Downloader</h2>
          <h4 className="my-2.5 text-lg leading-snug">
            Ang Y2Mate ay ang pinakamahusay na mabilis at libreng Youtube Downloader tool na tumutulong sa iyong
            madaling i-convert at i-download ang iyong mga paboritong video mula sa YouTube, Facebook, Vimeo, Youku,
            Twitch, Dailymotion, atbp nang walang advertising. gamit ang Y2mate converter na ito maaari kang
            mag-download ng mp3 at mp4 mula sa youtube nang walang limitasyon. Ito ay katugma at madaling gamitin sa
            lahat ng device gaya ng Android Mobiles, iOS, iPhone, Computer, at tablet.
          </h4>
          <h4 className="my-2.5 text-lg leading-snug">
            Hindi mo kailangang mag-install ng mga app at software. Nagbibigay ang Y2mate ng iba't ibang format ng audio
            at video na may kalidad ng HD tulad ng MP3, M4V, MP4, FLV, 3GP, AVI, WEBM, WMV atbp. Ito ay isang ligtas at
            mabilis na paraan upang mag-save ng mga video mula sa YouTube o anumang iba pang platform ng pagbabahagi ng
            video na may mga simpleng hakbang .
          </h4>
        </section>
        ...
        <section className="py-[30px] md:flex block justify-between">
          <div className="md:w-[60%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Mga tagubilin</strong></h5>
            <ol className="m-0 pl-4 list-decimal">
              <li className="mb-2.5 text-[17px]">Maglagay ng keyword sa input box o i-paste ang url ng video na gusto
                mong i-convert
              </li>
              <li className="mb-2.5 text-[17px]">I-click lamang ang pindutang "Start" at magsisimula ang conversion</li>
              <li className="mb-2.5 text-[17px]">Piliin ang format (Video, Audio) at ang kalidad para sa pag-download,
                pagkatapos ay i-click ang pindutang "I-download".
              </li>
            </ol>
          </div>
          <div className="md:w-[40%] md:px-[15px]">
            <h5 className="text-lg my-1.5 font-normal"><strong>Bentahe ng Y2mate</strong></h5>
            <ol className="m-0 pl-4 list-disc">
              <li className="mb-2.5 text-[17px]">Mag-enjoy ng walang limitasyong bilang ng mga video na na-download nang
                walang bayad
              </li>
              <li className="mb-2.5 text-[17px]">Hindi na kailangang magrehistro o mag-login ng isang account</li>
              <li className="mb-2.5 text-[17px]">Suportahan ang pag-download sa lahat ng mga format at katangian</li>
              <li className="mb-2.5 text-[17px]">Napakabilis ng pag-download at bilis ng conversion</li>
              <li className="mb-2.5 text-[17px]">100% Ligtas at secure na converter</li>
            </ol>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[25px] md:py-[30px] md:flex">
          <div className="md:w-1/3 text-center">
            ...
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Libre at walang limitasyong
              pag-download</h3>
            <p className="mb-2.5">Walang limitasyong conversion ng Mga Video sa Youtube at libreng pag-download</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/download.svg" placeholder="none" alt="y2mateDownload" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Madali at Mabilis na Pag-download</h3>
            <p className="mb-2.5">Ganap na Tugma sa lahat ng browser at device</p>
          </div>
          <div className="md:w-1/3 text-center">
            <StaticImage src="../../images/video.svg" placeholder="none" alt="y2mateSupport" quality={50}/>
            <h3 className="text-primary text-[22px] font-bold mb-2 mt-[22px]">Mataas na Kalidad ng Video at Audio</h3>
            <p className="mb-2.5">Suportahan ang mataas na kalidad na pag-download ng audio at mga video bilang orihinal
              na format</p>
          </div>
        </section>
        <hr className="md: w-5/6 h-px mx-auto bg-gray-200 border-0 rounded dark:bg-gray-700"/>
        <section className="py-[30px]">
          <p className="max-w-full mb-2.5"><b>Tip: </b> Alisin ang www sa URL at idagdag ang <b>“Y2mate”</b> bago ang
            "youtube.com" sa URL para mag-download ng mga video( MP4 ) at audio( MP3 ) file mula sa YouTube bilang mas
            mabilis na solusyon.
          </p>
          <p className="max-w-full mb-0.5">Kung hindi ka makapag-download ng video sa iyong Device, mangyaring sundin
            ang mga tagubiling ito:</p>
          <p className="max-w-full"><b>Step1: </b>piliin ang format na gusto mo at i-click ang "Download" na buton</p>
          <p className="max-w-full mb-2.5"><b>Step2: </b>Sa bagong window, i-click ang "CTRL + S" para i-save ang video
            O i-right click sa video, pagkatapos ay piliin ang "Save as Video".</p>
        </section>
      </div>
      <footer>
...
export const Head = () => (
  <>
    <html lang="tl-ph"/>
    <title>Y2mate - Youtube Downloader | I-download ang Youtube Video nang Libre sa HD</title>
    <meta
      name="description"
      content="Ang Y2mate ay madaling gamitin at makapangyarihang Youtube downloader na nagbibigay-daan sa iyong madaling i-save ang iyong paboritong Youtube video at i-download ang mga ito bilang mp3 na musika at mga mp4 na file nang libre"/>
    <meta name="robots" content="index,follow"/>
    <meta property="og:type" content="website"/>
    <meta property="og:site_name" content="y2mate"/>
    <meta property="og:locale" content="tl-ph"/>
    <meta property="og:title" content="Y2mate - Youtube Downloader | I-download ang Youtube Video nang Libre sa HD"/>
    <meta
      property="og:description"
      content="Ang Y2mate ay madaling gamitin at makapangyarihang Youtube downloader na nagbibigay-daan sa iyong madaling i-save ang iyong paboritong Youtube video at i-download ang mga ito bilang mp3 na musika at mga mp4 na file nang libre"/>
    <meta property="og:image" content="https://y2mate.mobi/icons/icon-256x256.png"/>
    <meta property="og:url" content="https://y2mate.mobi/tl-ph/"/>
    <link rel="icon" href="https://y2mate.mobi/icons/icon-256x256.png"/>
    <link rel="canonical" href="https://y2mate.mobi/tl-ph/"/>
    <DownloaderAlternate/>
  </>
)
